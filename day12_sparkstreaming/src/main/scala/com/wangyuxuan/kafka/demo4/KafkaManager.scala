...
//      val topicAndPartition: TopicAndPartition = TopicAndPartition(offset.topic, offset.partition)
//      val o: Either[Err, Map[TopicAndPartition, Short]] = kc.setConsumerOffsets(groupId, Map(topicAndPartition -> offset.untilOffset))
//      if (o.isLeft) {
